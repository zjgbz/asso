...
var_list = list("rs11248850", "rs11248850_del0", "rs11248850_del12", "del-rs11248850")
#if (cohort == "SOL") {
#	var_list = list("rs11248850", "rs11248850_del0", "rs11248850_del12", "rs11248850_cn2", "rs11248850_cn34","del-rs11248850")
#} else {
#	var_list = list("rs11248850", "rs11248850_del0", "rs11248850_del12", "del-rs11248850")
#}
if (cohort == "JHS") {
